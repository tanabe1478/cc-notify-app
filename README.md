...
```bash
git clone https://github.com/yourname/cc-notify-app.git
cd cc-notify-app
pnpm install
pnpm build
```
...
# Hook を手動テスト
echo '{"session_id":"test","cwd":"/tmp","permission_mode":"default","hook_event_name":"PermissionRequest","tool_name":"Bash","tool_input":{"command":"ls"}}' | pnpm dev:hook
```
